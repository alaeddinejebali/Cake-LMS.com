...
<title>
<?php if(wp_title ( '|', true,'right' ) != ''){	wp_title ( '|', true,'right' );}else{	get_default_value('nt_home_title');}; ?>
</title>
        ...
        <div id="header">
            <div id="logo" class="clearFix">
                ...
                <?php if(ot_get_option('upload_logo') === '' && ot_get_option('logo_type', 'logo') === 'name'):?>
                    <h1 class="logo-txt-h1"><a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a></h1>
                <?php else: ?>
