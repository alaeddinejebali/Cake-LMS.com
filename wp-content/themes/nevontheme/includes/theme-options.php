...
function custom_theme_options() {
  ...
  $custom_settings = array(
    ...
    'settings'        => array(
      ...
      array(
        'label'       => 'Theme shared on W P L O C K E R .C O M - Select site logo type',
        'id'          => 'logo_type',
        'type'        => 'select',
	  ...
	  array(
			...
			'section'     => 'general',
            'std'         => 'THEME Shared on www.MafiaShare.net - Designed by <a href="http://activeden.net/user/XanderRock/portfolio" target="_blank">XanderRock</a> © 2013 <a href="http://activeden.net/user/XanderRock/portfolio" target="_blank">Nevon Theme</a> | All Rights Reserved',
            'rows'        => '',
            'post_type'   => '',
            'taxonomy'    => '',
            'class'       => ''
