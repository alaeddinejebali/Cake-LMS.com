 ...
 */
?>
<div class='wrapper <?php echo in_array(ts_get_main_menu_style(),array('style2','style5','style6')) && get_post_meta(get_the_ID(),'transparent_content',true) == 'yes' ? 'transparent-content' : '' ?>'>
