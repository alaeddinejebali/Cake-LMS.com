...
function ts_custom_theme_options() {
	...
	$custom_settings = array(
		...
		'settings' => array(
			...
			array(
				'id' => 'translator_'.sanitize_title('More info'),
				'label' => __('More info', 'framework'),
				'desc' => '',
				'std' => '',
				'type' => 'text',
				'section' => 'translations',
			...
			array(
				'id' => 'translator_'.sanitize_title('Search'),
				'label' => __('Search', 'framework'),
				'desc' => '',
				'std' => '',
				'type' => 'text',
				'section' => 'translations',
			...
			array(
				'id' => 'translator_'.sanitize_title('Send message'),
				'label' => __('Send message', 'framework'),
				'desc' => '',
				'std' => '',
				'type' => 'text',
				'section' => 'translations',
			...
			array(
				'id' => 'translator_'.sanitize_title('Shop'),
				'label' => __('Shop', 'framework'),
				'desc' => '',
				'std' => '',
				'type' => 'text',
				'section' => 'translations',
			...
			array(
				'id' => 'translator_'.sanitize_title('This field is required.'),
				'label' => __('This field is required.', 'framework'),
				'desc' => '',
				'std' => '',
				'type' => 'text',
				'section' => 'translations',
