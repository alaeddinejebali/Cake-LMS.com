...
function ts_custom_meta_boxes() {
	...
	$page_options_boxes = array(
		...
		'fields' => array(
			...
			array(
				'id' => 'slider_content_background_color',
				'label' => __('Slider content background color', 'framework'),
				'desc' => '',
				'std' => '',
				'type' => 'colorpicker',
			...
			array(
				'id' => 'slider_content_background_transparency',
			...
			array(
				'id' => 'slider_content_min_height',
				'label' => __('Slider content area minimum height (px)', 'framework'),
				'desc' => '',
				'std' => '',
				'type' => 'text',
				'class' => 'template-alternative',
			...
			array(
				...
				'desc' => __('Main menu style 2,5 and 6 only', 'framework'),
				'std' => '',
				'type' => 'Radio',
				'rows' => '',
				'post_type' => '',
