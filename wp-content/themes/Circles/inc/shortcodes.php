...
require_once get_template_directory().'/inc/shortcodes/icon_6.php';
	...
	$aHelp = array(
		...
		*/
		...
		array(
			...
			'usage' => '[button color="#555555" style="1" size="small" icon="icon-briefcase" icon_upload="" url="http://yourdomain.com" target="_blank" ]Your content here...[/button]',
			'code' => '[button color="{color}" style="{style}" size="{size}" icon="{icon}" icon_upload="{iconupload}" target="{target}" url="{url}"]{content}[/button]',
			'fields' => array(
				'style' => array(
					'type' => 'select',
					'label' => __('Style', 'framework'),
				...
				'iconupload' => array(
					'type' => 'upload',
					'label' => __('Upload icon (style 2 only)', 'framework'),
					'desc' => ''
				),
				'url' => array(
					'type' => 'text',
		...
		array(
			...
			'description' => '',
			'usage' => '[featured_projects style="standard" category="" header="Featured projects" limit="6"]Your text here...[/featured_projects]',
			'code' => '[featured_projects style="{style}" category="{category}" header="{header}" limit="{limit}"]{description}[/featured_projects]',
			'fields' => array(
				'style' => array(
					'type' => 'select',
					'label' => __('Style', 'framework'),
		...
		array(
			...
			'description' => '',
			'usage' => '[icon_2 icon="img-1" icon_upload="" url="http://...." target="_blank" title="Your title" content="Your content here..."]',
			'code' => '[icon_2 icon="{icon}" icon_upload="{iconupload}" url="{url}" target="{target}" title="{title}" content="{content}"]',
			'fields' => array(
				'icon' => array(
					'type' => 'select',
					'label' => __('Icon (choose or upload below)', 'framework'),
		...
		array(
			...
			'description' => '',
			'usage' => '[icon_3 icon="icon-glass" icon_upload="" title="Your title"]Your content here...[/icon_3]',
			'code' => '[icon_3 icon="{icon}" icon_upload="{iconupload}" title="{title}"]{content}[/icon_3]',
			'fields' => array(
				'icon' => array(
					'type' => 'select',
					'label' => __('Icon (choose or upload below)', 'framework'),
		...
		array(
			...
			'description' => '',
			'usage' => '[icon_4 icon="icon-glass" icon_upload="" size="12" color="#FF0000"]',
			'code' => '[icon_4 icon="{icon}" icon_upload="{iconupload}" size="{size}" color="{color}"]',
			'fields' => array(
				'icon' => array(
					'type' => 'select',
					'label' => __('Icon (choose or upload below)', 'framework'),
		...
		array(
			...
			'description' => '',
			'usage' => '[icon_5 icon="icon_search" icon_upload="" color="#FF0000" title="Your title"]Your content here...[/icon_5]',
			'code' => '[icon_5 icon="{icon}" icon_upload="{iconupload}" icon_color="{iconcolor}" text_color="{textcolor}" title="{title}"]{content}[/icon_5]',
			'fields' => array(
				'icon' => array(
					'type' => 'select',
					'label' => __('Icon (choose or upload below)', 'framework'),
		...
		array(
			'shortcode' => 'icon_6',
			'name' => __('Icon 6','framework'),
			'description' => '',
			'usage' => '[icon_6 icon="icon-glass" icon_upload="" link_name="Learn more" url="http://...." target="_blank" title="Your title"]Your content here...[/icon_6]',
			'code' => '[icon_6 icon="{icon}" icon_upload="{iconupload}" link_name="{linkname}" url="{url}" target="{target}" title="{title}"]{content}[/icon_6]',
			'fields' => array(
				'icon' => array(
					'type' => 'select',
					'label' => __('Icon (choose or upload below)', 'framework'),
		...
		array(
			...
			'description' => '',
			'usage' => '[icon_box icon="icon-search" icon_upload="" animation="no" effect="no" url="http://..." target="_self" title="Your title"]Your content here...[/icon_box]',
			'code' => '[icon_box icon="{icon}" icon_upload="{iconupload}" animation="{animation}" effect="{effect}" url="{url}" target="{target}" title="{title}"]{content}[/icon_box]',
			'fields' => array(
				'icon' => array(
					'type' => 'select',
					'label' => __('Icon (choose or upload below)', 'framework'),
		...
		array(
			...
			'child' => array(
				'name' => __('Icon','framework'),
				'code' => '[icon_item type="{type}" icon_upload="{iconupload}" url="{url}" target="{target}" title="{title}"]{content}[/icon_item]',
				'fields' => array(
					'type' => array(
						'type' => 'select',
						'label' => __('Type', 'framework'),
		...
		array(
			...
			'name' => __('Our clients 2','framework'),
			'description' => '',
			'usage' => array('[our_clients_2 color="#DDD" border_color="#CC3312" first_page="no" last_page="no" fullwidth="no"][our_clients_2_item url="http://test.com" target="_blank"]image.png[/our_clients_2_item][/our_clients_2]'),
			'code' => '[our_clients_2 color="{color}" border_color="{bordercolor}" first_page="{firstpage}" last_page="{lastpage}" fullwidth="{fullwidth}"]{child}[/our_clients_2]',
			'fields' => array(
				'color' => array(
					'type' => 'colorpicker',
					'label' => __('Color', 'framework'),
		...
		array(
			...
			'child' => array(
				...
				'code' => '[step icon="{icon}" icon_upload="{iconupload}" icon_upload_hover="{iconuploadhover}" title="{title}" subtitle="{subtitle}" url="{url}" target="{target}"]',
				'fields' => array(
					'icon' => array(
						'type' => 'select',
						'label' => __('Icon (choose or upload below)', 'framework'),
					...
					'iconuploadhover' => array(
						'type' => 'upload',
						'label' => __('Upload icon (hover state)', 'framework'),
						'desc' => ''
					),
					'title' => array(
						'type' => 'text',
